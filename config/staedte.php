 ...
 */
$stadt = static fn (string $slug, string $name, string $bundesland, string $von, string $bis, float $lon, float $lat, array $bestand = [], bool $hauptsitz = false): array => [
    'slug' => $slug,
    'name' => $name,
...
return [
    ...
    $stadt('berlin', 'Berlin', 'Berlin', '10000', '16999', 13.4050, 52.5200, ['Berlin', 'Bernau bei Berlin']),
    ...
    $stadt('monheim-am-rhein', 'Monheim am Rhein', 'Nordrhein-Westfalen', '40700', '40999', 6.8895, 51.0967, [], true),
    $stadt('erkelenz', 'Erkelenz', 'Nordrhein-Westfalen', '41000', '44999', 6.3156, 51.0797, ['Erkelenz', 'Mönchengladbach', 'Remscheid']),
    $stadt('essen', 'Essen', 'Nordrhein-Westfalen', '45000', '47999', 7.0116, 51.4556, ['Gelsenkirchen']),
    $stadt('muenster', 'Münster', 'Nordrhein-Westfalen', '48000', '49999', 7.6261, 51.9607),
    $stadt('koeln', 'Köln', 'Nordrhein-Westfalen', '50000', '51999', 6.9603, 50.9375, ['Köln']),
    $stadt('aachen', 'Aachen', 'Nordrhein-Westfalen', '52000', '52999', 6.0839, 50.7753, ['Düren', 'Stolberg', 'Eschweiler', 'Linnich']),
    ...
    $stadt('ulm', 'Ulm', 'Baden-Württemberg', '88000', '89999', 9.9876, 48.4011, ['Friedrichshafen', 'Tettnang']),
